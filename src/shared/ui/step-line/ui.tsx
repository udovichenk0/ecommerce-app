...
export const StepLine = ({step}:{step: number}) => {
	return (
		<div className="w-full flex justify-between mb-10 relative after:content after:top-[15px] after:absolute after:w-[89%] after:h-[2px] after:bg-[#e1e1e1] after:ml-9 after:z-0">
			{steps.map(({checkStep, text}) => {
				return (
					<div key={checkStep} className="w-[100px]">
